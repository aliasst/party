            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xs-12">
                    <div class="cabinet-title-section cabinet-title-section-auth cabinet-title-section-sub">
                        ...
                        <div class="auth-subtitle">Придумайте новый пароль</div>
                    </div>
                </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-input">
                                                <input type="password" name="password" id="password"
                                                       value="" required=""
                                                       autocomplete="off" autofocus="" placeholder="Новый пароль *">
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-input">
                                                <input type="password" name="password_confirmation" id="password_confirmation"
                                                       value="" required=""
                                                       autocomplete="off" autofocus="" placeholder="Подтверждение пароля">
                                            </div>
