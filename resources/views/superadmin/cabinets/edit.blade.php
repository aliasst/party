            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xs-12">
                    <div class="cabinet-title-section">
                        <h1>Редактировать кабинет: {{ $cabinet->name }}</h1>
                    </div>
                </div>
                <div class="col-xs-12 col-md-8">
                    <div class="request-card card auth-card">
                        <div class="card-content">
                            <form method="POST" action="{{ route('superadmin.cabinets.update', $cabinet) }}">
                                @csrf
                                @method('PUT')
                                @if ($errors->any())
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        <div class="form-input">
                                            <input type="text" name="name" value="{{ old('name', $cabinet->name) }}" required placeholder="Название кабинета *">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
